...
public class MockFactory {
    ...
    public static EGVRecord[] mockEGVPage() throws ParseException {
        ...
        record[0] = new EGVRecord(108, TrendArrow.DOWN_45, 186923993, 186945595, Noise.CLEAN);
        record[1] = new EGVRecord(115, TrendArrow.FLAT, 186924293, 186945895, Noise.CLEAN);
        record[2] = new EGVRecord(137, TrendArrow.UP_45, 186924893, 186946495, Noise.CLEAN);
        record[3] = new EGVRecord(147, TrendArrow.UP_45, 186925193, 186946795, Noise.CLEAN);
        record[4] = new EGVRecord(245, TrendArrow.NOT_COMPUTABLE, 186941692, 186963294, Noise.CLEAN);
        record[5] = new EGVRecord(247, TrendArrow.NOT_COMPUTABLE, 186941992, 186963595, Noise.CLEAN);
        record[6] = new EGVRecord(244, TrendArrow.NOT_COMPUTABLE, 186942292, 186963894, Noise.CLEAN);
        record[7] = new EGVRecord(243, TrendArrow.NOT_COMPUTABLE, 186942592, 186964194, Noise.CLEAN);
        record[8] = new EGVRecord(240, TrendArrow.FLAT, 186942892, 186964494, Noise.CLEAN);
        record[9] = new EGVRecord(229, TrendArrow.DOWN_45, 186943192, 186964794, Noise.CLEAN);
        record[10] = new EGVRecord(213, TrendArrow.SINGLE_DOWN, 186943492, 186965094, Noise.CLEAN);
        record[11] = new EGVRecord(202, TrendArrow.SINGLE_DOWN, 186943792, 186965394, Noise.CLEAN);
        record[12] = new EGVRecord(206, TrendArrow.DOWN_45, 186944092, 186965694, Noise.CLEAN);
        record[13] = new EGVRecord(207, TrendArrow.FLAT, 186944392, 186965994, Noise.CLEAN);
        record[14] = new EGVRecord(205, TrendArrow.FLAT, 186944692, 186966294, Noise.CLEAN);
        record[15] = new EGVRecord(208, TrendArrow.FLAT, 186944992, 186966594, Noise.CLEAN);
        record[16] = new EGVRecord(212, TrendArrow.FLAT, 186945292, 186966894, Noise.CLEAN);
        record[17] = new EGVRecord(216, TrendArrow.FLAT, 186945592, 186967194, Noise.CLEAN);
        record[18] = new EGVRecord(219, TrendArrow.FLAT, 186945892, 186967494, Noise.CLEAN);
        record[19] = new EGVRecord(222, TrendArrow.FLAT, 186946192, 186967794, Noise.CLEAN);
        record[20] = new EGVRecord(225, TrendArrow.FLAT, 186946492, 186968094, Noise.CLEAN);
        record[21] = new EGVRecord(225, TrendArrow.FLAT, 186946792, 186968394, Noise.CLEAN);
        record[22] = new EGVRecord(224, TrendArrow.FLAT, 186947092, 186968694, Noise.CLEAN);
        record[23] = new EGVRecord(239, TrendArrow.FLAT, 186947692, 186969294, Noise.CLEAN);
        record[24] = new EGVRecord(249, TrendArrow.UP_45, 186947992, 186969594, Noise.CLEAN);
        record[25] = new EGVRecord(255, TrendArrow.UP_45, 186948292, 186969894, Noise.CLEAN);
        record[26] = new EGVRecord(272, TrendArrow.UP_45, 186948892, 186970494, Noise.CLEAN);
        record[27] = new EGVRecord(283, TrendArrow.SINGLE_UP, 186949192, 186970794, Noise.CLEAN);
        record[28] = new EGVRecord(284, TrendArrow.UP_45, 186949492, 186971094, Noise.CLEAN);
        record[29] = new EGVRecord(272, TrendArrow.FLAT, 186949792, 186971394, Noise.CLEAN);
        record[30] = new EGVRecord(278, TrendArrow.FLAT, 186950091, 186971694, Noise.LIGHT);
        record[31] = new EGVRecord(262, TrendArrow.FLAT, 186950391, 186971994, Noise.LIGHT);
        record[32] = new EGVRecord(234, TrendArrow.DOUBLE_DOWN, 186950691, 186972294, Noise.LIGHT);
        record[33] = new EGVRecord(155, TrendArrow.DOUBLE_DOWN, 186950992, 186972594, Noise.CLEAN);
        record[34] = new EGVRecord(135, TrendArrow.DOUBLE_DOWN, 186951291, 186972894, Noise.CLEAN);
        record[35] = new EGVRecord(122, TrendArrow.DOUBLE_DOWN, 186951591, 186973194, Noise.CLEAN);
        record[36] = new EGVRecord(118, TrendArrow.DOUBLE_DOWN, 186951893, 186973495, Noise.CLEAN);
        record[37] = new EGVRecord(121, TrendArrow.DOWN_45, 186952192, 186973794, Noise.CLEAN);
        record[38] = new EGVRecord(127, TrendArrow.FLAT, 186952492, 186974094, Noise.CLEAN);
        record[39] = new EGVRecord(137, TrendArrow.UP_45, 186952792, 186974394, Noise.CLEAN);
        record[40] = new EGVRecord(157, TrendArrow.UP_45, 186953692, 186975294, Noise.CLEAN);
        record[41] = new EGVRecord(158, TrendArrow.UP_45, 186953992, 186975594, Noise.CLEAN);
        record[42] = new EGVRecord(164, TrendArrow.UP_45, 186954292, 186975895, Noise.CLEAN);
        record[43] = new EGVRecord(164, TrendArrow.FLAT, 186954591, 186976194, Noise.CLEAN);
        record[44] = new EGVRecord(166, TrendArrow.FLAT, 186954891, 186976494, Noise.CLEAN);
        record[45] = new EGVRecord(174, TrendArrow.FLAT, 186955191, 186976794, Noise.CLEAN);
        record[46] = new EGVRecord(167, TrendArrow.FLAT, 186955491, 186977094, Noise.CLEAN);
        record[47] = new EGVRecord(170, TrendArrow.FLAT, 186955791, 186977394, Noise.CLEAN);
        record[48] = new EGVRecord(169, TrendArrow.FLAT, 186956091, 186977694, Noise.CLEAN);
        record[49] = new EGVRecord(168, TrendArrow.FLAT, 186956391, 186977994, Noise.CLEAN);
        record[50] = new EGVRecord(166, TrendArrow.FLAT, 186956691, 186978294, Noise.CLEAN);
        record[51] = new EGVRecord(166, TrendArrow.FLAT, 186956991, 186978594, Noise.CLEAN);
        record[52] = new EGVRecord(161, TrendArrow.FLAT, 186957291, 186978894, Noise.CLEAN);
        record[53] = new EGVRecord(171, TrendArrow.FLAT, 186957591, 186979194, Noise.CLEAN);
        record[54] = new EGVRecord(166, TrendArrow.FLAT, 186957891, 186979494, Noise.CLEAN);
        record[55] = new EGVRecord(173, TrendArrow.FLAT, 186958191, 186979794, Noise.CLEAN);
        record[56] = new EGVRecord(178, TrendArrow.FLAT, 186958491, 186980094, Noise.CLEAN);
        record[57] = new EGVRecord(181, TrendArrow.FLAT, 186959092, 186980695, Noise.CLEAN);
        record[58] = new EGVRecord(181, TrendArrow.FLAT, 186959092, 186980695, Noise.CLEAN);
        record[59] = new EGVRecord(186, TrendArrow.FLAT, 186959393, 186980995, Noise.CLEAN);
        record[60] = new EGVRecord(186, TrendArrow.FLAT, 186959393, 186980995, Noise.CLEAN);
        return record;
    }
