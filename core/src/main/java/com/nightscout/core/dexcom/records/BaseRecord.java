...
/**
 * Created by stephenblack on 3/27/15.
 */
public abstract class BaseRecord  {
    ...
    public BaseRecord(Date displayTime, Date systemTime) {
        this.displayTime = displayTime;
        this.systemTime = systemTime;
    }

    public BaseRecord(long rawDisplayTimeSeconds, long rawSystemTimeSeconds) {
    ...
    public BaseRecord(long rawSystemTimeSeconds) {
        this.rawSystemTimeSeconds = rawSystemTimeSeconds;
    }
