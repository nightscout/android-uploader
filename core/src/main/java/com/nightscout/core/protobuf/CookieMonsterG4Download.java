...
public final class CookieMonsterG4Download extends Message {

    public static final List<CookieMonsterG4SGV> DEFAULT_SGV = Collections.emptyList();
    ...
    public static final DownloadStatus DEFAULT_DOWNLOAD_STATUS = DownloadStatus.NA;
    public static final Integer DEFAULT_RECEIVER_BATTERY = 0;
    public static final Integer DEFAULT_UPLOADER_BATTERY = 0;
    public static final List<CookieMonsterG4Meter> DEFAULT_METER = Collections.emptyList();
    public static final List<CookieMonsterG4Sensor> DEFAULT_SENSOR = Collections.emptyList();
    public static final List<CookieMonsterG4Cal> DEFAULT_CAL = Collections.emptyList();

    @ProtoField(tag = 1, label = REPEATED)
    public final List<CookieMonsterG4SGV> sgv;
    ...
    public final List<CookieMonsterG4Meter> meter;

    @ProtoField(tag = 9, label = REPEATED)
    public final List<CookieMonsterG4Sensor> sensor;

    @ProtoField(tag = 10, label = REPEATED)
    public final List<CookieMonsterG4Cal> cal;

    public CookieMonsterG4Download(List<CookieMonsterG4SGV> sgv, GlucoseUnit units, String download_timestamp, Long receiver_system_time_sec, DownloadStatus download_status, Integer receiver_battery, Integer uploader_battery, List<CookieMonsterG4Meter> meter, List<CookieMonsterG4Sensor> sensor, List<CookieMonsterG4Cal> cal) {
    ...
    private CookieMonsterG4Download(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CookieMonsterG4Download)) return false;
        CookieMonsterG4Download o = (CookieMonsterG4Download) other;
    ...
    public static final class Builder extends Message.Builder<CookieMonsterG4Download> {

        public List<CookieMonsterG4SGV> sgv;
        ...
        public List<CookieMonsterG4Meter> meter;
        public List<CookieMonsterG4Sensor> sensor;
        public List<CookieMonsterG4Cal> cal;

        public Builder() {
        }

        public Builder(CookieMonsterG4Download message) {
            super(message);
        ...
        public Builder sgv(List<CookieMonsterG4SGV> sgv) {
         ...
         * Battery level as reported by the uploader
         */
        public Builder meter(List<CookieMonsterG4Meter> meter) {
            this.meter = checkForNulls(meter);
            return this;
        }

        public Builder sensor(List<CookieMonsterG4Sensor> sensor) {
            this.sensor = checkForNulls(sensor);
            return this;
        }

        public Builder cal(List<CookieMonsterG4Cal> cal) {
            this.cal = checkForNulls(cal);
            return this;
        }

        @Override
        public CookieMonsterG4Download build() {
            checkRequiredFields();
            return new CookieMonsterG4Download(this);
        }
    }
}
