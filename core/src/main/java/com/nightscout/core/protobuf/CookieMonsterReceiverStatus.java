...
public final class CookieMonsterReceiverStatus extends Message {
    ...
    public CookieMonsterReceiverStatus(Long timestamp_ms, List<ReceiverStatus> event) {
        this.timestamp_ms = timestamp_ms;
        this.event = immutableCopyOf(event);
    }

    private CookieMonsterReceiverStatus(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CookieMonsterReceiverStatus)) return false;
        CookieMonsterReceiverStatus o = (CookieMonsterReceiverStatus) other;
    ...
    public static final class Builder extends Message.Builder<CookieMonsterReceiverStatus> {
        ...
        public Builder(CookieMonsterReceiverStatus message) {
            super(message);
        ...
        @Override
        public CookieMonsterReceiverStatus build() {
            checkRequiredFields();
            return new CookieMonsterReceiverStatus(this);
        }
    }
}
