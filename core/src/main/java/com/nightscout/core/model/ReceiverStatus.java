...
public final class ReceiverStatus extends Message {
    ...
    public ReceiverStatus(Long timestamp_ms, List<ReceiverStatus> event) {
        this.timestamp_ms = timestamp_ms;
        this.event = immutableCopyOf(event);
    }

    private ReceiverStatus(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReceiverStatus)) return false;
        ReceiverStatus o = (ReceiverStatus) other;
    ...
    public static final class Builder extends Message.Builder<ReceiverStatus> {
        ...
        public Builder(ReceiverStatus message) {
            super(message);
        ...
        @Override
        public ReceiverStatus build() {
            checkRequiredFields();
            return new ReceiverStatus(this);
        }
    }
}
