...
public class PacketBuilderTest {
  ...
  public void testReadDatabasePageRangeCommand() {
    byte[]
        readDatabasePageRangeCommand =
        new byte[]{0x01, 0x07, 0x00, 0x10, 0x04, (byte) 0x8B, (byte) 0xB8};
    PacketBuilder
        builder =
        new PacketBuilder(Command.READ_DATABASE_PAGE_RANGE, Lists.newArrayList((byte) 0x04));
  ...
  public void testReadDatabasePagesCommand() {
    byte[]
        readDatabasePages =
        new byte[]{0x01, 0x0C, 0x00, 0x11, 0x05, 0x26, 0x00, 0x00, 0x00, 0x01, 0x5E, (byte) 0xC3};
    ArrayList<Byte>
        payload =
        Lists.newArrayList((byte) 0x05, (byte) 0x26, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                           (byte) 0x01);
