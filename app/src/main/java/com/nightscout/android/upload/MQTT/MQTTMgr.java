...
public class MQTTMgr implements MqttCallback,MQTTMgrObservable {
    ...
    // TODO: this should be kept for persistent MQTT connections.
    ...
    private void setupOpts(String lwt){
        ...
        // TODO: Implement lastwill options.
//        if (lastWill != null) {
...
//        }
    ...
    // TODO: this will be used to detect and eventually react to changes in the mobile network -
    // e.g. transitioning from wifi to cell or vice versa
    ...
    public void publish(byte[] message, String topic){
        ...
        try {
            mClient.publish(topic,message,0,true);
        } catch (MqttException e) {
    ...
    public void sendKeepalive() {
        ...
        try {
            ...
            mClient.publish(String.format(Locale.US, Constants.MQTT_KEEP_ALIVE_TOPIC_FORMAT, mDeviceId),message);
        } catch (MqttException e) {
