...
public final class SGV {
  ...
  public interface ProposedCookieMonsterG4DownloadOrBuilder
     ...
     * </pre>
     */
    java.util.List<ProposeCookieMonsterSGVG4>
        getSgvList();
    /**
     * <code>repeated .ProposeCookieMonsterSGVG4 sgv = 1;</code>
     *
     ...
     * </pre>
     */
    ProposeCookieMonsterSGVG4 getSgv(int index);
    /**
     * <code>repeated .ProposeCookieMonsterSGVG4 sgv = 1;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    java.util.List<? extends ProposeCookieMonsterSGVG4OrBuilder>
        getSgvOrBuilderList();
    /**
     * <code>repeated .ProposeCookieMonsterSGVG4 sgv = 1;</code>
     *
     ...
     * </pre>
     */
    ProposeCookieMonsterSGVG4OrBuilder getSgvOrBuilder(
            int index);
     ...
     * </pre>
     */
    ProposedCookieMonsterG4Download.Unit getUnits();
     ...
     * </pre>
     */
    ProposedCookieMonsterG4Download.DownloadStatus getDownloadStatus();
  ...
  public static final class ProposedCookieMonsterG4Download extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                sgv_ = new java.util.ArrayList<ProposeCookieMonsterSGVG4>();
                mutable_bitField0_ |= 0x00000001;
              }
              sgv_.add(input.readMessage(ProposeCookieMonsterSGVG4.PARSER, extensionRegistry));
              break;
            }
            case 16: {
              int rawValue = input.readEnum();
              Unit value = Unit.valueOf(rawValue);
              if (value == null) {
            ...
            case 32: {
              int rawValue = input.readEnum();
              DownloadStatus value = DownloadStatus.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return SGV.internal_static_ProposedCookieMonsterG4Download_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return SGV.internal_static_ProposedCookieMonsterG4Download_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ProposedCookieMonsterG4Download.class, Builder.class);
    }
    ...
    public enum Unit
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ProposedCookieMonsterG4Download.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public enum DownloadStatus
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ProposedCookieMonsterG4Download.getDescriptor().getEnumTypes().get(1);
      }
    ...
    private java.util.List<ProposeCookieMonsterSGVG4> sgv_;
    /**
     * <code>repeated .ProposeCookieMonsterSGVG4 sgv = 1;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    public java.util.List<ProposeCookieMonsterSGVG4> getSgvList() {
      return sgv_;
    }
    /**
     * <code>repeated .ProposeCookieMonsterSGVG4 sgv = 1;</code>
     ...
     * </pre>
     */
    public java.util.List<? extends ProposeCookieMonsterSGVG4OrBuilder>
        getSgvOrBuilderList() {
      return sgv_;
    }
    /**
     ...
     * </pre>
     */
    public ProposeCookieMonsterSGVG4 getSgv(int index) {
     ...
     * </pre>
     */
    public ProposeCookieMonsterSGVG4OrBuilder getSgvOrBuilder(
        int index) {
      return sgv_.get(index);
    }
    ...
    private DownloadStatus downloadStatus_;
    /**
     * <code>optional .ProposedCookieMonsterG4Download.DownloadStatus download_status = 4 [default = NONE];</code>
     *
     * <pre>
    ...
    private void initFields() {
      ...
      downloadStatus_ = DownloadStatus.NONE;
      receiverBattery_ = 0;
      uploaderBattery_ = 0;
    }
    ...
    public static ProposedCookieMonsterG4Download parseFrom(
    ...
    public static ProposedCookieMonsterG4Download parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ProposedCookieMonsterG4Download parseFrom(
    ...
    public static ProposedCookieMonsterG4Download parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ProposedCookieMonsterG4Download parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static ProposedCookieMonsterG4Download parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(ProposedCookieMonsterG4Download prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.nightscout.android.SGV.ProposedCookieMonsterG4Download.newBuilder()
      private Builder() {
      ...
      public ProposedCookieMonsterG4Download getDefaultInstanceForType() {
        return ProposedCookieMonsterG4Download.getDefaultInstance();
      }

      public ProposedCookieMonsterG4Download build() {
        ProposedCookieMonsterG4Download result = buildPartial();
      ...
      public ProposedCookieMonsterG4Download buildPartial() {
        ProposedCookieMonsterG4Download result = new ProposedCookieMonsterG4Download(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ProposedCookieMonsterG4Download) {
          return mergeFrom((ProposedCookieMonsterG4Download)other);
        } else {
      ...
      public Builder mergeFrom(ProposedCookieMonsterG4Download other) {
        if (other == ProposedCookieMonsterG4Download.getDefaultInstance()) return this;
        if (sgvBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ProposedCookieMonsterG4Download parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ProposedCookieMonsterG4Download) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      private void ensureSgvIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          sgv_ = new java.util.ArrayList<ProposeCookieMonsterSGVG4>(sgv_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          ProposeCookieMonsterSGVG4, ProposeCookieMonsterSGVG4.Builder, ProposeCookieMonsterSGVG4OrBuilder> sgvBuilder_;
      ...
      public Builder setSgv(
          int index, ProposeCookieMonsterSGVG4 value) {
        if (sgvBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setSgv(
          int index, ProposeCookieMonsterSGVG4.Builder builderForValue) {
        if (sgvBuilder_ == null) {
          ensureSgvIsMutable();
       ...
       * </pre>
       */
      public Builder addSgv(ProposeCookieMonsterSGVG4 value) {
        if (sgvBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addSgv(
          ProposeCookieMonsterSGVG4.Builder builderForValue) {
        if (sgvBuilder_ == null) {
          ensureSgvIsMutable();
      ...
      public Builder addAllSgv(
          Iterable<? extends ProposeCookieMonsterSGVG4> values) {
        if (sgvBuilder_ == null) {
          ensureSgvIsMutable();
       ...
       * </pre>
       */
      public ProposeCookieMonsterSGVG4.Builder getSgvBuilder(
          int index) {
       ...
       * </pre>
       */
      public ProposeCookieMonsterSGVG4.Builder addSgvBuilder() {
        return getSgvFieldBuilder().addBuilder(
            ProposeCookieMonsterSGVG4.getDefaultInstance());
      }
      /**
       * <code>repeated .ProposeCookieMonsterSGVG4 sgv = 1;</code>
       *
      ...
      public ProposeCookieMonsterSGVG4.Builder addSgvBuilder(
          int index) {
        return getSgvFieldBuilder().addBuilder(
            index, ProposeCookieMonsterSGVG4.getDefaultInstance());
      }
      /**
       * <code>repeated .ProposeCookieMonsterSGVG4 sgv = 1;</code>
       *
       ...
       * </pre>
       */
      public java.util.List<ProposeCookieMonsterSGVG4.Builder>
           getSgvBuilderList() {
        return getSgvFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ProposeCookieMonsterSGVG4, ProposeCookieMonsterSGVG4.Builder, ProposeCookieMonsterSGVG4OrBuilder>
          getSgvFieldBuilder() {
        if (sgvBuilder_ == null) {
       ...
       * </pre>
       */
      public Builder setUnits(Unit value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000002;
      ...
      // optional .ProposedCookieMonsterG4Download.DownloadStatus download_status = 4 [default = NONE];
      private DownloadStatus downloadStatus_ = DownloadStatus.NONE;
      /**
       * <code>optional .ProposedCookieMonsterG4Download.DownloadStatus download_status = 4 [default = NONE];</code>
       *
       * <pre>
       ...
       * </pre>
       */
      public Builder setDownloadStatus(DownloadStatus value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000008;
  ...
  public interface ProposeCookieMonsterSGVG4OrBuilder
     ...
     * </pre>
     */
    ProposeCookieMonsterSGVG4.Direction getDirection();
  }
  /**
  ...
  public static final class ProposeCookieMonsterSGVG4 extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return SGV.internal_static_ProposeCookieMonsterSGVG4_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return SGV.internal_static_ProposeCookieMonsterSGVG4_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ProposeCookieMonsterSGVG4.class, Builder.class);
    }
    ...
    public enum Direction
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ProposeCookieMonsterSGVG4.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public static ProposeCookieMonsterSGVG4 parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static ProposeCookieMonsterSGVG4 parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ProposeCookieMonsterSGVG4 parseFrom(
    ...
    public static ProposeCookieMonsterSGVG4 parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static ProposeCookieMonsterSGVG4 parseFrom(
    ...
    public static ProposeCookieMonsterSGVG4 parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static ProposeCookieMonsterSGVG4 parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(ProposeCookieMonsterSGVG4 prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      // Construct using com.nightscout.android.SGV.ProposeCookieMonsterSGVG4.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public ProposeCookieMonsterSGVG4 getDefaultInstanceForType() {
        return ProposeCookieMonsterSGVG4.getDefaultInstance();
      }

      public ProposeCookieMonsterSGVG4 build() {
        ProposeCookieMonsterSGVG4 result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public ProposeCookieMonsterSGVG4 buildPartial() {
        ProposeCookieMonsterSGVG4 result = new ProposeCookieMonsterSGVG4(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ProposeCookieMonsterSGVG4) {
          return mergeFrom((ProposeCookieMonsterSGVG4)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(ProposeCookieMonsterSGVG4 other) {
        if (other == ProposeCookieMonsterSGVG4.getDefaultInstance()) return this;
        if (other.hasSgv()) {
          setSgv(other.getSgv());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ProposeCookieMonsterSGVG4 parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ProposeCookieMonsterSGVG4) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  static {
    String[] descriptorData = {
      ...
      "_COMPUTABLE\020\010\022\025\n\021RATE_OUT_OF_RANGE\020\tB\035\n\026" +
      "com.nightscout.androidB\003SGV"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ProposedCookieMonsterG4Download_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ProposedCookieMonsterG4Download_descriptor,
              new String[] { "Sgv", "Units", "DownloadTimestamp", "DownloadStatus", "ReceiverBattery", "UploaderBattery", });
          internal_static_ProposeCookieMonsterSGVG4_descriptor =
            getDescriptor().getMessageTypes().get(1);
          internal_static_ProposeCookieMonsterSGVG4_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ProposeCookieMonsterSGVG4_descriptor,
              new String[] { "Sgv", "Timestamp", "Direction", });
          return null;
        }
      };
