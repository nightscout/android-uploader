...
abstract class CommonUsbSerialDriver implements UsbSerialDriver {
  ...
  /**
   * Sets the size of the internal buffer used to exchange data with the USB stack for read
   * operations.  Most users should not need to change this.
   *
  ...
  /**
   * Sets the size of the internal buffer used to exchange data with the USB stack for write
   * operations.  Most users should not need to change this.
   *
   * @param bufferSize the size in bytes
   */
