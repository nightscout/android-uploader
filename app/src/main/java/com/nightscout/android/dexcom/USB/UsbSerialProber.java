...
/**
 * Helper class to assist in detecting and building {@link UsbSerialDriver} instances from available
 * hardware.
 *
...
/*    SILAB_SERIAL {
  ...
  /**
   * Acquires and returns the first available serial device among all available {@link
   * android.hardware.usb.UsbDevice}s, or returns {@code null} if no device could be acquired.
   *
   * @param usbManager the {@link android.hardware.usb.UsbManager} to use
   * @return the first available {@link UsbSerialDriver}, or {@code null} if no devices could be
   * acquired
   */
  ...
  /**
   * Builds and returns a new {@link UsbSerialDriver} from the given {@link
   * android.hardware.usb.UsbDevice}, or returns {@code null} if no drivers supported this device.
   *
   * @param usbManager the {@link android.hardware.usb.UsbManager} to use
   * @param usbDevice  the {@link android.hardware.usb.UsbDevice} to use
   * @return a new {@link UsbSerialDriver}, or {@code null} if no devices could be acquired
   */
  ...
  /**
   * Builds a new {@link UsbSerialDriver} instance from the raw device, or returns <code>null</code>
   * if it could not be built (for example, if the probe failed).
   *
