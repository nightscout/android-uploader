...
/**
 * Utility class which services a {@link UsbSerialDriver} in its {@link #run()} method.
 *
...
public class SerialInputOutputManager implements Runnable {
  ...
  /**
   * Continuously services the read and write buffers until {@link #stop()} is called, or until a
   * driver exception is raised.
   *
