...
import com.nightscout.android.dexcom.RecordTypes;
...
public class PageHeader {
    ...
    public PageHeader(byte[] packet) {
        ...
        recordType = RecordTypes.values()[packet[RECTYPE_OFFSET]];
        ...
        System.arraycopy(packet,HEADER_SIZE- G4Constants.CRC_LEN,crc,0,G4Constants.CRC_LEN);
        byte[] crc_calc = CRC16.calculate(packet,0,HEADER_SIZE - G4Constants.CRC_LEN);
