...
public class Pebble {
  ...
  public PebbleDictionary buildDictionary(TrendArrow trend, String bgValue, int recordTime,
                                          int uploaderTimeSec,
  ...
  private void init() {
    PebbleKit
        .registerReceivedDataHandler(context, new PebbleKit.PebbleDataReceiver(PEBBLEAPP_UUID) {
          @Override
          public void receiveData(final Context mContext, final int transactionId,
