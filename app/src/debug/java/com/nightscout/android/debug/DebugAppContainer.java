...
public class DebugAppContainer implements AppContainer {
    ...
    @InjectView(R.id.debug_egv_input)
    EditText egvInput;
    @InjectView(R.id.debug_generate_egv_button)
    Button generateEgvButton;
    ...
    public ViewGroup get(final Activity activity) {
        ...
        generateEgvButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EGVRecord record = new EGVRecord(input, TrendArrow.NONE, new DateTime(), new DateTime(), G4Noise.NOISE_NONE, new DateTime());
